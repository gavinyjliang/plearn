# 可视化打包 exe，这个Python神器绝了

<a id="profileBt"></a><a id="js_name"></a>Python程序员 *2021-10-07 08:30*

<img width="677" height="381" src="../../../_resources/640_wx_fmt_jpeg_wxfrom_5_wx_lazy_3b3d91db3fa94e88b.jpg"/>
...
<img width="677" height="444" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__236c5e78b1f44288a.png"/>
...
<img width="677" height="194" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__fdad02aa89c047f9b.png"/>
...
<img width="677" height="666" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__031155a20c9e4af98.png"/>

如果程序里面有自己的模块，我们必须把模块的目录添加到 Additional Files 里面。不然会出现 Failed to execute script XXX 错误

<img width="677" height="184" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__d967009f52fd48649.png"/>
...
<img width="677" height="610" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__907902f92a73496d9.png"/>

在打包文件目录中，我们可以看到一个 main.exe 文件，这就是我们打包文件。

点击 main.exe ，就可以看到一个计算器程序了。

<img width="677" height="331" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__b249f13723e84b968.png"/>
