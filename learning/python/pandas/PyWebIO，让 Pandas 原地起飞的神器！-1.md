...
<a id="copyright_logo"></a>Original 刘早起 <a id="profileBt"></a><a id="js_name"></a>早起Python *2021-11-05 10:24*
...
<img width="669" height="149" src="../../../_resources/640_wx_fmt_jpeg_wxfrom_5_wx_lazy_a01f3280298944029.jpg"/>
...
读取之后呢，就会进入到下面的页面，我们继续讲解该其他功能的实现<img width="669" height="603" src="../../../_resources/640_wx_fmt_jpeg_wxfrom_5_wx_lazy_f8ea7d5b74064b1da.jpg"/>

## 添加按钮与事件

有关标题和文字部分的讲解见该系列第一篇文章，本文不再赘述。

现在来重点讲解一下，如何添加一个按钮，简单来说就是如何实现像下图一样，点击按钮实现对应功能<img width="669" height="598" src="../../../_resources/640_wx_fmt_jpeg_wxfrom_5_wx_lazy_d6343ec448b9461fa.jpg"/>
...
以上页面都是在本地写的，**如果想让你的页面让任何人都能访问，就需要有一台服务器了！**
...
<img width="420" height="398" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__adc29b4cb4a24bb29.png"/>

收录于话题 #<a id="js_album_keep_read_title"></a>用服务器做好玩的事儿

 <a id="js_album_keep_read_size"></a>5个

<a id="js_album_prev"></a>上一篇 <a id="js_album_keep_read_pre_title"></a>用 Python 写的 web 页面，如何让所有人都能访问？ <a id="js_album_next"></a>下一篇 <a id="js_album_keep_read_next_title"></a>像数据分析一样写 Web 页面，这个 Python 库做到了！

Modified on 2021-11-05
...
<img width="102" height="102" src="../../../_resources/qrcode_scene_10000004_size_102___1a8ed44ec4004abca.bmp"/>
