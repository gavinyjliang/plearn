...
<a id="js_article-tag-card__left"></a>收录于合集 #Pandas <a id="js_article-tag-card__right"></a>29个

导读

前2篇分别系统性介绍了numpy和matplotlib的入门基本知识，今天本文自然是要对pandas进行入门详细介绍，通过本文你将系统性了解pandas为何会有数据分析界"瑞士军刀"的盛誉。

<img width="431" height="300" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__87d0e15ef6f748caa.png"/>
...
<img width="371" height="213" src="../../../_resources/640_wx_fmt_png_wxfrom_5_wx_lazy__7f74c2df78b04bbe8.png"/>
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588672609579099373.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588644414751042357.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588608065044051189.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588648054010053031.png")

切片形式返回行查询，且为范围查询

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588647935619010217.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588646954694002263.png")

- query，按列对dataframe执行条件查询，一般可用常规的条件查询替代
    

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588648417634043582.png")

- get，由于series和dataframe均可以看做是类字典结构，所以也可使用字典中的get()方法，主要适用于不确定数据结构中是否包含该标签时，与字典的get方法完全一致
    

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588648558973027452.png")

- lookup，loc的一种特殊形式，分别传入一组行标签和列标签，lookup解析成一组行列坐标，返回相应结果：
    

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588648784466063223.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588660415770044649.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588671877243093321.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588679847811068546.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588655509054079994.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588656232955009905.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588658881014057305.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588658781646029393.png")

- applymap，**仅适用于dataframe对象**，且是对dataframe中的每个元素执行函数操作，从这个角度讲，与replace类似，applymap可看作是dataframe对象的通函数。
    

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588659054210025900.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588682419528086342.png")

建表语句

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588663425194090501.png")

通过设置参数，concat和merge实现相同效果

06 数据分析

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588671001234093287.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588664348723057201.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588664822054030319.png")

- unique、nunique，也是仅适用于series对象，统计唯一值信息，前者返回唯一值结果列表，后者返回唯一值个数(number of unique）
    

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588664960996037797.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588667128617042350.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588668648783003634.png")

pandas官网关于groupby过程的解释

级联其他聚合函数的方式一般有两种：单一的聚合需求用groupby+聚合函数即可，复杂的大量聚合则可借用agg函数，agg函数接受多种参数形式作为聚合函数，功能更为强大。

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588668192064085287.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588669776564023664.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588670340752057259.png")

07 数据可视化

![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588610096369072156.png")
...
![Image](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "https://image.ipaiban.com/upload-ueditor-image-20200505-1588650215535042245.png")
...
<img width="102" height="102" src="../../../_resources/qrcode_scene_10000004_size_102___bad88ba6223a4fbd8.bmp"/>
